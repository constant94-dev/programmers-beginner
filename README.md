...
그런다음 다음번 순위 판별을 위해 순위를 '1'로 초기화 해서 전체 평균점수에 대한 순위를 매길 수 있다... 하지만, 코드를 제출해보니 12개 케이스 중 2개가 오류가 난다... 이유를 찾기 위해 입력값 노가다를 시작... 최소,최대,중간 값 대입을 해보니 문제가 확인할 수 있었다...
</h4>
...
<h4>
Day23_3 문제 풀이 중 발음할 수 있는 단어를 조합해야 된다고 생각했다... 왜냐하면 문제에서 제시된 입출력 예시를 확인해보니 입력으로 주어진 문자열이 서로가 붙어서 문자열을 이루더라도 발음할 수 있는 단어가 되기 때문이다... 그래서 총 4개의 문자열을 2개씩, 3개씩, 4개씩 조합해서 입력값과 비교해 같을 때마다 결과를 1증가 해주는 작성했다... 이렇게 코드를 만들고 제출하니 한번에 통과했다... 하지만, 다른 사람들은 어떻게 작성했는지 궁금해 찾아보았다...
</h4>
